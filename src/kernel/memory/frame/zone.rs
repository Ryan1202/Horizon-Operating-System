...
impl ZoneType {
    ...
    pub const fn range(&self) -> Range<PhysAddr> {
        match self {
            #[cfg(target_pointer_width = "32")]
            ZoneType::LinearMem => (PhysAddr::new(0x100000)..PhysAddr::new(0x30000000)).into(),
            #[cfg(target_pointer_width = "64")]
            ZoneType::LinearMem => (PhysAddr::new(1 << 32)..PhysAddr::new(usize::MAX)).into(),

            #[cfg(target_pointer_width = "32")]
            ZoneType::MEM32 => (PhysAddr::new(0x30000000)..PhysAddr::new(usize::MAX)).into(),
            #[cfg(target_pointer_width = "64")]
            ZoneType::MEM32 => (PhysAddr::new(0)..PhysAddr::new(1 << 32)).into(),
        }
    }
