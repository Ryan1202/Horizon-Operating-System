...
pub const KLINEAR_RANGE: Range<VirtAddr> = (KLINEAR_BASE..KLINEAR_END).into();
...
pub const VMALLOC_RANGE: Range<VirtAddr> = (VMALLOC_BASE..VMALLOC_END).into();
...
pub const VMEMMAP_RANGE: Range<VirtAddr> = (VMEMMAP_BASE..VMEMMAP_END).into();
...
pub const KERNEL_RANGE: Range<VirtAddr> = (KERNEL_BASE..KERNEL_END).into();
